//nếu làm xong About thì chuyển sang { name: "About", href: "/about" }
...
function AccountIcon() {
  return (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <path d="M5 24C5.8 18.8 9.2 16 14 16C18.8 16 22.2 18.8 23 24" stroke="black" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
...
function SearchIcon() {
  return (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <path d="M18.5 18.5L24 24" stroke="black" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
...
function HeartIcon() {
  return (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path d="M14 24C13.5 23.6 5 18.2 5 10.8C5 7 7.5 4.5 10.7 4.5C12.6 4.5 13.8 5.4 14 6.1C14.2 5.4 15.4 4.5 17.3 4.5C20.5 4.5 23 7 23 10.8C23 18.2 14.5 23.6 14 24Z" stroke="black" strokeWidth="2" strokeLinejoin="round" />
    </svg>
  );
}
...
function CartIcon() {
  return (
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path d="M5 6H8L10 19H22L24 10H10" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <header className="sticky top-0 z-50 h-[100px] bg-white">
        <div className="relative mx-auto h-full w-full max-w-[1440px] px-5 lg:px-0">
          ...
          <div className="absolute right-[54px] top-1/2 hidden -translate-y-1/2 items-center gap-[45px] lg:flex">
            ...
            <IconButton label="Open cart" onClick={() => setIsCartOpen(true)}>
              <CartIcon />
            </IconButton>
          </div>
