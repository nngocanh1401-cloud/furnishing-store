              ...
              <div className="flex items-center gap-[25px]">
                ...
                <div className="flex items-center text-black">
                  <a
                    ...
                    className="mr-[25px] transition hover:text-[#B88E2F]"
                  >
                    <FacebookIcon />
                  </a>
                  ...
                  <a
                    ...
                    className="mr-[23px] transition hover:text-[#B88E2F]"
                  >
                    <LinkedInIcon />
                  </a>
                  ...
                  <a
                    ...
                    className="transition hover:text-[#B88E2F]"
                  >
                    <TwitterIcon />
                  </a>
                </div>
