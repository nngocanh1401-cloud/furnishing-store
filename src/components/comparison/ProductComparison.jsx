...
export default function ProductComparison() {
  ...
  const [selectedCompareProductId, setSelectedCompareProductId] = useState("");
  const [productsToCompare, setProductsToCompare] = useState([]); // khong co sp trong compare ban dau
